...
export default async function Page() {
  return (
    <>
      <div className="mx-auto mt-30 md:mt-10 relative">
        {/* <!-- SignupForm spans 2 columns starting from column 2 --> */}
        <LoginForm className="w-sm" />
      </div>

      <div className="absolute w-full md:w-fit left-1/2 -translate-x-1/2 top-40 md:px-0 px-10 md:top-20 text-muted-foreground flex items-center gap-x-2">
