    ...
    <>
      ...
      <div className="border border-amber-900 w-full">
        <div className="text-center">
          <h1 className="md:text-5xl sm:text-4xl text-3xl font-medium">Resource Hub</h1>
      ...
      <div className="mt-10 border border-amber-800 w-full">
        <div className="text-center">
          <h2 className="md:text-3xl text-2xl  font-normal ">explore all our resources</h2>
      ...
      <div className="w-full border border-amber-700 mt-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 md:mt-5">
        <ResourceSidebar className="md:col-span-1 col-span-full border border-amber-700" />
        <ResourceList />
      </div>
    </>
  );
